    ...
    const configKVs: Prisma.ConfigKVCreateManyInput[] = [
      {
        ...
        value: {
          ...
          categories: [
            ...
            { key: "data_and_privacy", title: "What data they would give an AI, and privacy", sampleQuestions: ["What data would you be willing to put into an AI tool at that company, and what would you keep out?", "How would you stop something confidential leaking into a prompt?", "Would you be comfortable building an app on Lovable and selling it to a healthcare or fintech enterprise in the US?", "What would that actually take before you could ship it to them?"] },
            { key: "rag_mcp", title: "RAG / MCP conceptual fluency", sampleQuestions: ["If you were giving an assistant access to your company's documents, how would you set that up?", "How would you tell whether it was actually doing a good job — not just sounding right?", "Which connectors would you give it, and which would you refuse?", "Name one skill you would build in your workspace, and why that one.", "Say you are working on three different projects at work and your LLM keeps confusing them when it answers. How would you make sure that stops happening?"] },
