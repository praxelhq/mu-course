...
Until those steps are recorded, the change is a release candidate, not a live product. Roll back web and worker to the preceding deployment together if necessary; retain additive tables, submissions and file versions. No schema rollback or data deletion is required.
