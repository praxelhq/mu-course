...
export default function Home(): React.ReactNode {
  return (
    <main>
      <header className="site-header"><Brand /><nav aria-label="Main navigation"><a href="#workflow">How it works</a><a href="#output">Output</a><a href="#pricing">Pricing</a><Link href="/docs">Docs</Link><Link href="/blog">Blog</Link></nav><Link className="header-cta" href="/workspace">Start a build</Link></header>
      <section className="hero">
        <div className="hero-copy"><span className="hero-eyebrow">PRODUCT URL → VERIFIED BUILD SEQUENCE</span><h1>Copy the product logic.<br />Build your version.</h1><p>Paste a product URL. Verify what the AI understood. Get the exact Build Sequence to build it for your niche.</p><div className="hero-actions"><Link className="button primary" href="/workspace">Analyze a product <ArrowRight size={18} /></Link><a className="button secondary" href="#workflow">See the workflow</a></div></div>
        <HeroFlow />
      </section>
      ...
      <footer><Brand /><p>Adapt the logic. Don’t imitate the identity.</p><nav aria-label="Site"><Link href="/docs">Docs</Link><Link href="/blog">Blog</Link><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link></nav><span>© 2026 VibesClone</span></footer>
    </main>
  );
}
