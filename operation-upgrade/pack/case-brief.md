...
1. Whatever you build, one person's name is on it. I want to know who I am calling when it is wrong.
2. Nobody loses their job because of this. If your plan needs that, bring me a different plan.
3. Our customers' details and our people's details never go into anything public. That one is not a discussion.
4. The till system and the payroll system stay exactly where they are. We are not replacing those this year.
5. You will not fix everything. Tell me what you are choosing not to fix, and be able to defend it.

## What you have

- **₹40 lakh a year**, for as long as your plan runs.
- **90 days** until she presents to the board.
- **Four changes.** Not four problems — four changes. Two against one problem is allowed and is often the strongest move.
...
- **Rahul Desai**, people and hiring. One of two recruiters carrying sixty open roles across five cities.
- **Sneha Varma**, brand and marketing. One of the two people who hold the brand in their heads.
