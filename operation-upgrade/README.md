...
A student is hired by Meera Iyer to change how her 25-outlet food business
...
person — Meera setting the terms, Arun explaining the shelf, Priya reporting
...
| The plan | Evaluation is not the leftover budget | A second AI system makes testing compulsory, with Meera's reason attached |
...
- `cast.ts` — Meera, Arun, Priya and the rest, the mandate, the five rules
