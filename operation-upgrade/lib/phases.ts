...
export const PHASES: readonly Phase[] = [
  ...
  { id: "offer", n: 1, short: "The offer", title: "Cutesh hires them", facilitator: "Let them read his note. Do not narrate it — he does the briefing.", minutes: 3, together: false },
  ...
  { id: "review", n: 8, short: "Review", title: "A second opinion", facilitator: "Mariga arrives for anyone whose plan is in trouble; everyone else gets two questions. Two minutes, then move on.", minutes: 5, together: false },
  { id: "memo", n: 9, short: "Sign it", title: "The memo, and lock", facilitator: "They finish and lock. After this nothing changes.", minutes: 8, together: false },
  { id: "pitch", n: 10, short: "Pitch", title: "Four take the floor", facilitator: "Mark four on the console. Seventy-five seconds each, and challenge one of them.", minutes: 10, together: true },
  { id: "vote", n: 11, short: "Fund one", title: "The room funds one plan", facilitator: "Everyone votes once and nobody votes for themselves.", minutes: 4, together: true },
  { id: "debrief", n: 12, short: "Debrief", title: "What the room learned", facilitator: "Walk the wall. The interlock count and the brain failures are the two to sit on.", minutes: 6, together: true },
  { id: "close", n: 13, short: "Close", title: "Radar and commitment", facilitator: "Protected. Do not let anything above eat into this.", minutes: 20, together: true },
  { id: "done", n: 14, short: "Done", title: "Course complete", facilitator: "", minutes: 0, together: false },
];
